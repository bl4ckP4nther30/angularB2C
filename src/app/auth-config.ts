...
export const b2cPolicies = {
    ...
    authorities: {
        signUpSignIn: {
            authority: 'https://Identifenceaadb2ctraining.b2clogin.com/Identifenceaadb2ctraining.onmicrosoft.com/B2C_1A_SIGNUP_SIGNIN',
        },
        forgotPassword: {
    ...
    authorityDomain: 'Identifenceaadb2ctraining.b2clogin.com',
};
